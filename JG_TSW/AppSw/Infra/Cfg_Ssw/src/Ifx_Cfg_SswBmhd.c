...
const Ifx_Ssw_Bmhd bmhd_0_orig=
{
    ...
    0xA0000020,     /**< \brief 0x004: .stad: User Code start address*/
    0xBBF1C52A,     /**< \brief 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)*/
    0x440E3AD5,     /**< \brief 0x00C: .crcInv: Inverted Check Result for the BMI Header (offset 000H - 007H)*/
#else
