...
#else
int adi_wil_ex_printf(const char * format, ...)
{
    return 0;
}
#endif
...
#else
int adi_wil_ex_info(const char * format, ...)
{
    return 0;
}
#endif
...
#else
int adi_wil_ex_error(const char * format, ...)
{
    return 0;
}
#endif
...
#else
int adi_wil_ex_fatal(const char * format, ...)
{
    return 0;
}
#endif
