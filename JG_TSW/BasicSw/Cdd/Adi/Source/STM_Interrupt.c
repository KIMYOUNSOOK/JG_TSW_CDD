...
#if 1 // @SURE - ADDED
#if 0 // Using MCAL GPT Interrupt TIMER
void _Scheduler_1ms_Trigger(uint8 nId)
{
...
#else
#if 1 // Using MCAL GPT Interrupt TIMER
    Gpt_StartTimer(GptConf_GptChannelConfiguration_GptChannelConfiguration_3, TIMER_INT_TIME*100000U); // 1ms(100000U)
#else
    _TmrId = TestGpt_RegTimer(TIMER_INT_TIME*1000, GPT_CONTINUE, _Scheduler_1ms_Trigger);
