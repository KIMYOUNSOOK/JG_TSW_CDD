...
**  VERSION   : 8.0.0                                                         **
**                                                                            **
**  DATE, TIME: 2023-01-11, 18:41:59      !!!IGNORE-LINE!!!               **
**                                                                            **
...
static const Lin_17_AscLin_ChannelType  Lin_kChannelConfigurationCore0[1] =
{
  /* LIN Channel ID: 0 Configuration */
  {
    /* BaudRate : 19200 Hz  */
    {
        192U,  /* BRG.NUMERATOR value */
        1000U,    /* BRG.DENOMINATOR value */
        124U,  /* BITCON.PRESCALAR value */
        468U,  /* Prescalar value for wakeup detection */
        1U, /* Inter byte or response space value */
        63U /* IOCR DEPTH value for wakeup detection */
    },
    0xFFU,                            /* EcuM Wakeup Source ID */
    LIN_17_ASCLIN10,   /* Hw Module used */
