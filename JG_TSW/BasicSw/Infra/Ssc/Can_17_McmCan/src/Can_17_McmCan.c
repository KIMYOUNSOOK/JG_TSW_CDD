...
#if (CAN_17_MCMCAN_SW_PATCH_VERSION != 1U)
...
#if 0 /* RSW */
volatile Ifx_CAN_RXMSG *pCanRxMsg = (void *)0;
volatile Ifx_CAN_TXMSG *pCanTxMsg = (void *)0;
#endif
...
void Can_17_McmCan_MainFunction_Write(void)
{
  ...
  {
    /* [cover parentID={3275CDEB-E482-4ed7-A2B8-12D24D4B9C43}]
    AUTOSAR version is 4.2.2 and DET is enabled
    [/cover] */
    #if ((CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON) && \
                                               (MCAL_AR_VERSION == MCAL_AR_422))
    /* Report to DET */
    /* [cover parentID={0928CAC9-5A7A-49fe-AD49-AB36975EDAA6}]
    Report to DET CAN_17_MCMCAN_E_UNINIT
    [/cover] */
    (void)Det_ReportError(CAN_17_MCMCAN_MODULE_ID, CAN_17_MCMCAN_INSTANCE_ID,
                   CAN_17_MCMCAN_SID_MAINFUNCTIONWRITE, CAN_17_MCMCAN_E_UNINIT);
    #endif
  }
...
void Can_17_McmCan_MainFunction_Read(void)
{
  ...
  {
    /* [cover parentID={AE57BB33-AB9C-4849-BADD-91CEF4586730}]
    AUTOSAR version is 4.2.2 and DET is enabled
    [/cover] */
    #if ((CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON) && \
                                               (MCAL_AR_VERSION == MCAL_AR_422))
    /* Report to DET */
    /* [cover parentID={859F456A-1F68-49d8-9DB0-2E0AF7CF96E8}]
    Report DET CAN_17_MCMCAN_E_UNINIT
    [/cover] */
    (void)Det_ReportError(CAN_17_MCMCAN_MODULE_ID, CAN_17_MCMCAN_INSTANCE_ID,
                    CAN_17_MCMCAN_SID_MAINFUNCTIONREAD, CAN_17_MCMCAN_E_UNINIT);
    #endif
  }
  #endif
}
...
void Can_17_McmCan_MainFunction_BusOff(void)
{
  ...
  {
    /* [cover parentID={8A7C22D5-9F9D-4792-853E-F951E90E7EC0}]
    AUTOSAR version is 4.2.2 and DET is enabled
    [/cover] */
    #if ((CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON) && \
                                               (MCAL_AR_VERSION == MCAL_AR_422))
    /* Report to DET */
    /* [cover parentID={40706D9B-5F88-4d55-A5A1-9F68D5F0F412}]
    Report DET
    [/cover] */
    (void)Det_ReportError(CAN_17_MCMCAN_MODULE_ID, CAN_17_MCMCAN_INSTANCE_ID,
                          CAN_17_MCMCAN_SID_MAINFUNCTIONBUSOFF,
                          CAN_17_MCMCAN_E_UNINIT);
    #endif
  }
...
void Can_17_McmCan_MainFunction_Wakeup(void)
{
  ...
  {
    /* [cover parentID={92546C40-6FFD-4df1-BB1D-B80DB55156C6}]
    AUTOSAR version is 4.2.2 and DET is enabled
    [/cover] */
    #if ((CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON) && \
                                               (MCAL_AR_VERSION == MCAL_AR_422))
    /* Report to DET */
    /* [cover parentID={08C50227-2B83-4fe9-8AC8-83B5E1235A41}]
    Report DET
    [/cover] */
    (void)Det_ReportError(CAN_17_MCMCAN_MODULE_ID, CAN_17_MCMCAN_INSTANCE_ID,
                  CAN_17_MCMCAN_SID_MAINFUNCTIONWAKEUP, CAN_17_MCMCAN_E_UNINIT);
    #endif
  }
  ...
  if (CAN_17_MCMCAN_ADDRESS_CHECK != RxReadStartAddr)
  {
...

    {
      ...
      RetVal = Can_17_McmCan_kGblConfigPtr->
                             CanLPduRxCalloutFuncPtr((uint8)(RxMailBoxInfo.Hoh),
                                                          RxMsgId,
                                                          RxMsgDLC,
      ...
      #endif /* #if (CAN_17_MCMCAN_LPDU_RX_CALLOUT == STD_ON) */
      {
        ...
        /*MISRA2012_RULE_1_3_JUSTIFICATION:This rule violation is
        agreed as we refer to this address while passing to the called function
        as a parameter (pass by value).Making this global limits the requirement
        of reentrancy in this function.*/
            ...
            const Can_17_McmCan_CoreGlobalType *const CoreGlobalPtr)
{
      ...
      ConfigPtr->CanEventHandlingConfigPtr[CtrlIndex].CanTxProcessing)
  {
          ...
          (CAN_17_MCMCAN_NOOF_TX_HW_BUFF_AVAILABLE > LoopExitFlag))
    {
      ...
      /* Load EventFIFO element address */
      /* MISRA2012_RULE_11_6_JUSTIFICATION: The pointer cast is used to
      cast the address of Tx Event Type to the event elements structure
      type */
      /* MISRA2012_RULE_11_4_JUSTIFICATION: conversion between pointer
      and integer type. Permitted for special function registers.*/
      TxEvntReadData = (volatile Ifx_CAN_TXEVENT *)TxEvntFIFORealAddr;
...
void Can_17_McmCan_lTxPeriodHandler(const uint8 HthRefPeriods)
{
  ...
  {
    /*UNINIT DET is reported only in AUTOSAR version 4.2.2*/
    /* [cover parentID={F1A4C0E7-34F4-4b58-9032-833A2E7F7B9C}]
    AUTOSAR version is 4.2.2 and DET is enabled
    [/cover] */
    #if ((CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON) && \
    (MCAL_AR_VERSION == MCAL_AR_422))
    ...
    /* Report to DET CAN_17_MCMCAN_E_UNINIT */
    /* [cover parentID={6910DE1E-D517-49a0-86CD-B716617CDD01}]
    Report DET
    [/cover] */
    (void)Det_ReportError(CAN_17_MCMCAN_MODULE_ID, CAN_17_MCMCAN_INSTANCE_ID,
                   CAN_17_MCMCAN_SID_MAINFUNCTIONWRITE, CAN_17_MCMCAN_E_UNINIT);
...
void Can_17_McmCan_lRxPeriodHandler(const uint8 HrhRefPeriods)
{
  ...
  {
    /* [cover parentID={CAC1D527-9BF4-4e38-BEF2-211181A9F9C7}]
    AUTOSAR version is 4.2.2 and DET is enabled
    [/cover] */
    #if ((CAN_17_MCMCAN_DEV_ERROR_DETECT == STD_ON) && \
                                               (MCAL_AR_VERSION == MCAL_AR_422))
    /* Report to DET */
    /* [cover parentID={C1F903C5-F0FF-4dbc-AA0E-57474766ED82}]
    Report DET
    [/cover] */
    (void)Det_ReportError(CAN_17_MCMCAN_MODULE_ID, CAN_17_MCMCAN_INSTANCE_ID,
                    CAN_17_MCMCAN_SID_MAINFUNCTIONREAD, CAN_17_MCMCAN_E_UNINIT);
...
of this function and more redable to have it in single function.
*/
/*******************************************************************************
...
cyclomatic Complexity of 16 because this function handles the DET checks of both
AUTOSAR versions of Can_Write. All checks are implemented as part
of this function and are more redable to have it in single function.
*/
/*******************************************************************************
                                     ...
                                     const uint8 NodeIdIndex)
{
  ...
  this condition check as the comparison is between two similar SFR reads.
  The latest value of FOFL is required hence it is not captured in a local*/
