...
#define MCU_EVRUVMON_DEINIT_VALUE ((uint32)0x0075A7B8U)
#define MCU_EVRMONCTRL_DEINIT_VALUE ((uint32)0x00A5A5A5U)
#endif
    ...
    */
         ...
         (0x1U << MCU_STANDBY)) > 0x0U)
    {
      ...
      MCU_LIB_INIT_DEINIT_WRITESAFETYENDINITPROTREG(&PMS_EVRUVMON.U,
          Mcu_ConfigPtr->McuLowPowerModeCfgPtr->Evruvmon);

      MCU_LIB_INIT_DEINIT_WRITESAFETYENDINITPROTREG(&PMS_EVRMONCTRL.U,
          Mcu_ConfigPtr->McuLowPowerModeCfgPtr->EvrmonCtrl);
      /*[/cover]*/  
    }
  ...
  #endif
  {
    ...
    */
         ...
         ((uint32)0x1U << MCU_STANDBY)) > 0x0U)
    {
      ...
      MCU_LIB_INIT_DEINIT_WRITESAFETYENDINITPROTREG(&PMS_EVRUVMON.U,
          MCU_EVRUVMON_DEINIT_VALUE);

      MCU_LIB_INIT_DEINIT_WRITESAFETYENDINITPROTREG(&PMS_EVRMONCTRL.U,
          MCU_EVRMONCTRL_DEINIT_VALUE);
    }
